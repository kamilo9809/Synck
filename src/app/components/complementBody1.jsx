  ...
  return (
    <div className=" flex flex-col justify-center items-center ">
      <div className="h-customBoxText flex flex-col justify-end items-center">
        ...
        <br />
        <p className="parrafo2 text-center text-gray-300">
          Una revolucionaria plataforma web y móvil diseñada para{" "}
          <span className="font-bold text-white">artistas y productores</span>{" "}
          tanto amateurs como experimentados que desean compartir sus creaciones
          musicales de manera sencilla, atractiva y efectiva.
        </p>
        <br />
        <br />
      </div>
